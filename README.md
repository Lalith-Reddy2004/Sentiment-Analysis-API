...
Fine-tuned a DistilBERT model on a custom dataset for multi-class sentiment analysis. Deployed as a REST API using FastAPI with Docker containerisation.
